<?php
	$openinviter_settings=array(
		"username"=>"gbagrov",
		"private_key"=>"f71a9dbdaece171117bd2f594e3808de",
		"cookie_path"=>'/tmp',
		"message_body"=>"You are invited to http://www.gbagrov.com", 
		"message_subject"=>" is inviting you to http://www.gbagrov.com",
